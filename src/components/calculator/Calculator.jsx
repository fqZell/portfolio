...
const Calculator = () => {
  ...
  const [websitePages, setWebsitePages] = useState(1);
  ...
  const handleWebsiteTypeChange = (event) => {
    ...
    if (selectedType === "landing") {
      ...
      setSliderProgress((websitePages / 10) * 100);
    }
  ...
  const calculateCost = () => {
    ...
    const pagesCost = websitePages * 1500;
            ...
            <Form className="form-calculator">
              ...
              <Form.Group>
                ...
                <div className="slider-container">
                  <Form.Range min={1} max={10} value={websitePages} onChange={handleWebsitePagesChange} disabled={websiteType === "landing"} />
